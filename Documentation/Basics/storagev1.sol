...
// in a database that you can query and alter by calling functions of the code that maanages the database.
...
// This ontract only allows to store a single number that is accessible by anyone in the world without a (feasable) way to prevent you from publishing this number.
